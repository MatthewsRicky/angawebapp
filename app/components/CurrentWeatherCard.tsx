...
export default function CurrentWeatherCard() {
  return (
    <main className="flex items-center justify-center">
      <div className="flex flex-col items-center justify-between py-2 px-3 min-w-w-fit border-2 rounded-2xl bg-gradient from-blue-50/70 to-blue-100/90 border-blue-500/20 shadowxl w-full">
        <h1 className="text-base font-redular text-gray-600/90 shadowsm py-1 px-2 rounded-sm mt-1 bg-element">
          Today
        </h1>

        <div className="flex w-full text-gray-700/80 items-center justify-between shadowsm p-3 mt-4 rounded-xl bg-element">
          <h2 className="text-3xl font-medium my-2">Rainy</h2>
          <span className="text-7xl p-4 w-1/2">
            <BsCloudRainHeavy />
          </span>
        ...
        <div className="flex px-2 items-center w-full justify-around gap-6 text-base bg-element rounded-lg shadowsm mb-1">
